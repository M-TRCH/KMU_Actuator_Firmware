...
void AS5X47::writeData(uint16_t command, uint16_t value) 
{
...
uint16_t AS5X47::readData(uint16_t command, uint16_t nopCommand) 
{
  SPI.beginTransaction(SPISettings(100000, MSBFIRST, SPI_MODE1));
